...
const promoteToAdminSchema = zod_1.z.object({
    userId: zod_1.z.string(),
});
const updateRoleSchema = zod_1.z.object({
    role: zod_1.z.enum(["FREEMIUM", "PREMIUM", "ADMIN"]),
});
async function adminRoutes(fastify) {
    fastify.post("/promote-admin", {
        ...
        try {
            ...
            if (!currentUser || !(0, roleHelper_1.isAdmin)(currentUser.role)) {
