            ...
            <div className="flex-grow p-6 overflow-y-auto space-y-4">
              {cartItems.length === 0 ? (
                ...
                cartItems.map((item) => (
                  <div
                    key={item.variant.id}
                    className="flex items-center gap-4 glass-card p-3 rounded-lg"
                  >
                    <img
            ...
            {cartItems.length > 0 && (
              <div className="p-6 border-t border-white/10">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold py-3 text-base"
                >
                  Proceed to Checkout
                </Button>
              </div>
